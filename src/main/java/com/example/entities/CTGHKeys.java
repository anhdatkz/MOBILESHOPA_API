...
public class CTGHKeys implements Serializable{
	...
	public CTGHKeys(String idgiohangctgh, String maloaictgh) {
		super();
	...
	public String getIdgiohangctgh() {
		return idgiohangctgh;
	}


	public void setIdgiohangctgh(String idgiohangctgh) {
		this.idgiohangctgh = idgiohangctgh;
	}
